process MULTIQC_SOFTMASK_OVERLAPS {
    ...
    echo "# description: 'This plot shows a brief summary of the overlaps (Jaccard index)  between the soft masks generated by each process'" >> jaccard_indexes_mqc.tsv
